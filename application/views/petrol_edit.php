<?php
$res=$this->db->get_where('tb_petrol',array('id'=>$pet),1);
foreach ($res->result() as $row){
?>
<?php echo form_open('admin_controller/tableupdate/'.$pet,array('id'=>'upd'));?>
<table class="table table-bordered table-striped">
    <tr id="tedit1"><td><input type="text" name="lp" class="form-control" value="<?php echo $row->Litre_petrol;?>" >
...
<script>
        $('#upd').submit(function(e){
            ...
            var urlp="<?php echo site_url('admin_controller/tableupdate');?>";
