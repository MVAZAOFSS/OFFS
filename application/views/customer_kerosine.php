<div class="infom">
   ...
   <?php
    $res=$this->db->get_where('tb_kerosine',array('id'=>$customer));
    if($res->num_rows()===1){
 ...
 <li class="list-group-item">Total litre of kerosene taken<span class="pull-right"><?php echo ''.$row->credit_litre;?></span></li>
    ...
    <?php echo form_open('accountant_controller/payed_kerosine/'.$row->id,array('class'=>'form-input asyn'));?>
    <ul class="list-group">
