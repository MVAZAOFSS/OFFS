<div class="infom">
   ...
   <?php
    $res=$this->db->get_where('tb_diesel',array('id'=>$customer));
    if($res->num_rows()===1){
    ...
    <ul class="list-group">
        ...
        <li class="list-group-item">Total litre of diesel taken<span class="pull-right"><?php echo ''.$row->credit_litre;?></span></li>
    ...
    <?php echo form_open('accountant_controller/payed_diesel/'.$row->id,array('class'=>'form-input asyn'));?>
    <ul class="list-group">
 ...
 <?php
    ...
    $('.asyn').submit(function(e){
        e.preventDefault();
        $('.succ').html('<label class="alert-warning">Saving....please wait.</label>');
